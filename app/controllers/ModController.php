...
//		parent::__construct();
	...
	public function getView($mod_id = null)
	{
		...
		return View::make('mod.view', array('solderVersion' => self::getSolderVersion(), 'solderStream' => self::getSolderStream()))->with(array('mod' => $mod));
	}
	...
	public function getVersions($mod_id = null)
	{
		...
		return View::make('mod.versions', array('solderVersion' => self::getSolderVersion(), 'solderStream' => self::getSolderStream()))->with(array('mod' => $mod));
	}

	public function postRehash($ver_id = null)
	{
		if (empty($ver_id))
			return Redirect::to('mod/list');
	...
	public function postDeleteVersion($ver_id = null)
	{
		if (empty($ver_id))
			return Redirect::to('mod/list');
